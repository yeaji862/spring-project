            ...
            $.ajax({
               ...
               success:function(data){
                 ...
                 for (let arrC of data) {
                   ...
                   $('.ch').attr('class' , 'comm re reply'+arrC.comment_num);
                   $('.reply'+arrC.comment_num).attr('onclick' , 'reply_btn("'+arrC.user_name+'" , "'+arrC.comment_num+'" , "'+num+'")');
                 if(user_name == arrC.user_name){
                   $('#comment_btn').append('<span id="replyEx" class="re comm c_de'+arrC.comment_num+'" >삭제 </span>')
                 ...
                 if(arrC.replyList != null){
                   for (let arrR of arrC.replyList) {
                     ...
                     $('.imgC').attr('class' , 'img_comment '+arrC.comment_num);
                     $('.'+arrR.comment_num).attr('src' , '/profile_img/'+arrR.user_img_file);
                   ...
                   if(user_name == arrR.user_name){
                     $('#reply_btn').append('<span id="replyEx" class="re comm r_de'+arrR.comment_num+'" >삭제 </span>')
