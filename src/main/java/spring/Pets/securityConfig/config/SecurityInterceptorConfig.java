package spring.Pets.securityConfig.config;

import spring.Pets.memberImpl.MemberMapper;
import spring.Pets.securityConfig.interceptor.SocialLoginInterceptor;
...
public class SecurityInterceptorConfig implements WebMvcConfigurer {
    ...
    private String resourcePath_profile = "file:///C:/Users/Administrator/Desktop/upload_img/profile/";
    private String connectPath_post = "/post_img/**";
    private String resourcePath_post = "file:///C:/Users/Administrator/Desktop/upload_img/post/";
    @Autowired
